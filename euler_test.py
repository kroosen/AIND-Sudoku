...
https://gist.github.com/oforero/7e9335c7bb759feffb7f57c0a15f0082#file-euler_test-py

In order to successfully pass these tests, diagonal units must be disabled in utils.py!
"""
...
class EulerSudokus(unittest.TestCase):
    boards = ["..53.....8......2..7..1.5..4....53...1..7...6..32...8..6.5....9..4....3......97..",            
    ...
    def test_solve(self):
        for board in self.boards:
            ...
            if not solved:
                print("Failed board # %s: %s" % (self.boards.index(board) + 1, board[0:20]))
            else:
                print("SOLVED board # %s: %s" % (self.boards.index(board) + 1, board[0:20]))
